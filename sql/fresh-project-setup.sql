-- Complete setup for fresh Supabase project with enterprise authentication
-- This script creates the full schema with your custom email patterns for admin access
