-- COMPLETE SETUP SCRIPT - Run this AFTER cleanup
-- This creates everything fresh with your email as admin
...
-- 3. Create enhanced Tickets table
...
-- 4. Create Knowledge Articles table
...
-- Allow admins to create accounts for others
...
-- 11. Update search vectors for knowledge articles
...
-- ✅ Setup Complete with your email pattern as admin!
SELECT 'Database setup complete! You can now sign up with prajwal.mac2025+fixieadmin@gmail.com and get admin access!' as status;
